...
<script type="text/javascript">
	var urls = {
		...
		"本单位审核":"<%=cp%>/project/check/list.jsp?type=bdw",
		"教育厅审核":"<%=cp%>/project/check/list.jsp?type=edu",
		"评审分组":"pingshen/group/list.jsp",
		"评审打分":"pingshen/score/list.jsp",
		"评审决策":"pingshen/decision/list.jsp",
		"专家推荐":"expert/list/list.jsp",
		"专家审核":"<%=cp%>/expert/check/list.jsp",
		"用户管理":"<%=cp%>/user/list.jsp",
		"代码管理":"code/admin/codelibs.jsp"
		//"项目打分"："pingshen/score/project.jsp"
	};
