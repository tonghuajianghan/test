		...
		<table id="main_table">
				...
				<td colspan="3">
					<div class="easyui-layout" fit="true">
                        <div split="true" style="height:100px;">
                            <textarea id="remark" maxlength="200" name="obj.remark" style="border:1px solid gray;width:98%;height:100%;resize:none"></textarea>
                        </div>
                    </div>
				</td>
			</tr>
			<tr height="110px">
				...
				<td colspan="3">
					<div class="easyui-layout" fit="true">
                        <div split="true" style="height:100px;">
                            <textarea id="groupExplain" maxlength="200" name="obj.groupExplain" style="border:1px solid gray;width:98%;height:100%;resize:none"></textarea>
                        </div>
                    </div>
				</td>
			</tr>
