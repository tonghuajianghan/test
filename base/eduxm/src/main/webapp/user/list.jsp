...
<body>
	...
	<form id="searchForm" action="../user/list_user.action"
		method="post">
		<table id="tableid">
		</table>
		...
		<div id="emailWin" class="easyui-dialog" closed=true>
			<div style="width: 100%; margin: 20px 0;">
				发 送给：
				<div id="stus" style="width: 85%"></div>
			</div>
			<div style="width: 100%; margin: 20px 0;">
				主题：<input style="width: 85%" name="title" class="easyui-validatebox"
					required=true />
			</div>
			<div style="width: 100%; margin: 10px 0;">
				内容：
				<textarea id="content" name="content" class="easyui-validatebox"
					rows="10" cols="70" style="width: 85%"></textarea>
			</div>
		</div>
	</form>
	...
	<div style="height: 40px; width: 100%;">
		<div
			style="width: 100%; top: 68px; right: 20px; font-size: 12px; text-align: right; color: #020e30;">
			<a class='easyui-linkbutton' href="javascript:void(0);"
				iconCls='icon-search' onclick="submitSerach(1);">开始检索</a>
		</div>
	</div>
