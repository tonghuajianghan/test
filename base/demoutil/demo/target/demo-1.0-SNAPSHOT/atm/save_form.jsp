...
<head>
	...
	<script type="text/javascript" src="../atm/js/save_form.js"></script>
	
</head>
<body>
	<div class="demo-info">
        <div class="demo-tip icon-tip"></div>
        <div>欢迎使用ATM<font size="+1" color="red"><b>存款</b></font>业务。请在下方正确输入您的存款金额。</div>
    </div>
	...
	<form id="saveform" action="save.action" method="post">
		<table>
			<tr>
	       	...
	       	<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
			<tr>
	       		<td colspan="2" align="right"><a href="javascript:void(0)" iconCls="icon-ok" class="easyui-linkbutton" onclick="saveMoney();return false;">确&nbsp;&nbsp;定</a></td>
			</tr>
		</table>
	</form>
</body>
