...
public abstract class Page {
	//private Logger log = Logger.getLogger(Page.class);
	protected int pageNum = 1;//页码，从1开始
	
	protected int recordNum = 10;//每页记录数
	...
	public ArrayList<?> getOnePage(final String sql, final List<?> params, ResultSetExtractor<Object> rse, JdbcTemplate jt){
