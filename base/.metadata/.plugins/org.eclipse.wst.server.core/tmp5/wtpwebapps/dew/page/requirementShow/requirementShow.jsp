...
<body>
	...
	<div id="templatemo_body_wrapper">
		<div id="templatemo_wrapper">
			...
			<ul>
			 	<li>
					<h3><a href="<%=basePath%>requirementpage.action?recotype=0&recotype2=11&mypage=first&jhpage=0">笔记本</a></h3>
		...
		<div class="menu-cont-list" style="display: none;">
			...
			<!-- 中间显示信息 --><!-- 右侧显示 -->
			 ...
			 <!-- <div class="infor-list-first">
			  ...
			  <div>			  			  
		        <center> 
			      <a href="<%=basePath%>requirement.action?mypage=past&jhpage=<%=jhpage %>">上一页</a>
			      <a href="<%=basePath%>requirement.action?mypage=next&jhpage=<%=jhpage %>">下一页</a>
			    </center>		
