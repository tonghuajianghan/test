...
<html>
  <head>
    ...
    <link href="files/qa/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/qa/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_形状">
        <img id="u0_img" class="img " src="images/qa/u0.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u2" class="ax_image">
        <img id="u2_img" class="img " src="images/qa/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u4" class="ax_image">
        <img id="u4_img" class="img " src="images/qa/u4.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (多行文本框) -->
      <div id="u6" class="ax_多行文本框">
        <textarea id="u6_input"></textarea>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u7" class="ax_image">
        <img id="u7_img" class="img " src="images/qa/u7.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u11" class="ax_形状">
        <img id="u11_img" class="img " src="images/qa/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u13" class="ax_image">
        <img id="u13_img" class="img " src="images/qa/u13.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u15" class="ax_image">
        <img id="u15_img" class="img " src="images/qa/u15.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u17" class="ax_文本段落">
        ...
        <div id="u18" class="text">
          <p><span>欢迎使用万达产品服务智能机器人</span></p>
        </div>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u19" class="ax_形状">
        <img id="u19_img" class="img " src="images/qa/u19.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u23" class="ax_文本段落">
        ...
        <div id="u24" class="text">
          <p><span>&nbsp;&nbsp; 系统管理员,主要分为网络信息管理员和系统信息管</span><span>理员。网络信息管理员主要负责整个网络的网络设备和</span><span>服务器系统的设计...</span></p>
        </div>
      </div>
      ...
      <div id="u29" class="ax_文本段落">
        ...
        <div id="u30" class="text">
          <p><span style="color:#F88F07;">只要</span><span style="color:#FFFFFF;">你想问，</span></p><p><span style="color:#333333;">&nbsp; &nbsp; &nbsp; </span><span style="color:#FFFFFF;">没有我</span><span style="color:#F88F07;">不知道</span><span style="color:#FFFFFF;">。</span></p>
        </div>
      </div>
      ...
      <div id="u31" class="ax_文本段落">
        ...
        <div id="u32" class="text">
          <p><span>2015-7-29 15:</span><span>20</span></p>
        </div>
      </div>
      ...
      <div id="u33" class="ax_水平线">
        ...
        <img id="u33_line" class="img " src="images/qa/u33_line.png" alt="u33_line"/>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u34" class="ax_image">
        <img id="u34_img" class="img " src="images/qa/u34.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u36" class="ax_image">
        <img id="u36_img" class="img " src="images/qa/u13.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u38" class="ax_形状">
        <img id="u38_img" class="img " src="images/qa/u38.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u40" class="ax_形状">
        <img id="u40_img" class="img " src="images/qa/u40.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u42" class="ax_文本段落">
        ...
        <div id="u43" class="text">
          <p><span>什么是系统管理员</span><span>？</span></p>
        </div>
      </div>

      <!-- Unnamed (Image) -->
      <div id="u44" class="ax_image">
        <img id="u44_img" class="img " src="images/qa/u44.png"/>
        <!-- Unnamed () -->
